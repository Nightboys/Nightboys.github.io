...
var _default2 = {
  ...
  methods: {
    ...
    calcTabHeight: function calcTabHeight() {
      // 计算表头高度
      var theads = (0, _webpackZepto.default)("#uiTab" + this.tabId + " .tab-filed"),
          theadsList = [],
          iconBtns = (0, _webpackZepto.default)("#uiTab" + this.tabId + " .icon-btn");
      theads.forEach(function (element) {
        theadsList.push((0, _webpackZepto.default)(element).height());
      });
      ...
      var rowsFixed = (0, _webpackZepto.default)("#uiTab" + this.tabId + " .tab-left .tab-list-item"),
          rowsFixedList = [],
          rowsOther = (0, _webpackZepto.default)("#uiTab" + this.tabId + " .tab-right .tab-list-item"),
          rowsOtherList = [],
          maxHeightList = [];
      rowsFixed.forEach(function (element) {
        element.style.height = '';
        rowsFixedList.push((0, _webpackZepto.default)(element).height());
      });
      rowsOther.forEach(function (element) {
        element.style.height = '';
        rowsOtherList.push((0, _webpackZepto.default)(element).height());
      });
      ...
      rowsFixed.forEach(function (element, index) {
        (0, _webpackZepto.default)(element).css({
    ...
    jump: function jump(type, e) {
      ...
      if (this.handleAnimate) {
        var tbodyH = (0, _webpackZepto.default)("#uiTab" + this.tabId + " .tab-body").height();
        this.tbodyContentStyle = (0, _extends2.default)({}, this.tbodyContentStyle, {
    ...
    resetRowsHeight: function resetRowsHeight() {
      ...
      (0, _webpackZepto.default)("#uiTab" + this.tabId + " .tab-filed").css({
        height: 'auto'
      }); //表头theader

      (0, _webpackZepto.default)("#uiTab" + this.tabId + " .tab-list-item").css({
        height: 'auto'
      }); //表体tbody
