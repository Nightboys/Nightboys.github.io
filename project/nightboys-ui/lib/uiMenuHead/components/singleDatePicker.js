...
var _datePickerBtn = _interopRequireDefault(require("./datePickerBtn"));

require("./singleDatePicker-sfc.css");
...
var _default = {
  ...
  components: {
    datePicker: _datePickerBtn.default
  },
  props: {
    clist: Array,
    idx: Number,
  ...
  data: function data() {
    return {
      list: _jquery.default.extend(true, [], this.clist),
      hasScroll: true,
      showtips: false,
      flag: false
    };
  ...
  watch: {
    clist: {
      ...
      handler: function handler() {
        this.list = _jquery.default.extend(true, [], this.clist);
        this.hasScroll = true;
        this.checkHasScroll();
      }
    }
  ...
  methods: {
    ...
    selectedItem: function selectedItem(o, obj) {
      ...
      var selectList = o.selected ? [(0, _extends2.default)({}, o, {
        params: obj.key
      })] : [];
