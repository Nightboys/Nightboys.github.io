...
exports.replaceSepcialTxt = exports.removeObjectNil = exports.oneOf = exports.isUndefined = exports.isNull = exports.isEmpty = exports.formatDate = exports.dateDesc = exports.change_minheight = void 0;
 ...
 * @return {{}}
 */
var removeObjectNil = function removeObjectNil(object) {
  if (!object) return {};
  var newObject = {};
...
var oneOf = function oneOf(val, list) {
  return list.indexOf(val) > -1;
};

exports.oneOf = oneOf;

var isUndefined = function isUndefined(val, unit, num) {
  if (unit === void 0) {
    unit = "";
  }
...
var dateDesc = function dateDesc(value) {
  if (!value) return '';
...
var formatDate = function formatDate(value, format, newFormat) {
  if (format === void 0) {
    format = 'YYYYMMDD';
  }
...
var change_minheight = function change_minheight() {
  var $window = $(window);
...
exports.change_minheight = change_minheight;

var replaceSepcialTxt = function replaceSepcialTxt(txt) {
...
exports.replaceSepcialTxt = replaceSepcialTxt;