...
var _request = function _request(_ref) {
  ...
  var alertMethod = this instanceof _vue.default ? this.$alert : _vue.default.alert;
  return new Promise(function (resolve, reject) {
    var xhr = _webpackZepto.default.ajax((0, _extends2.default)({
      url: action,
      type: method,
      data: params,
      headers: headers
      ...
      success: function success(res) {
        ...
        if (returncode !== 0) {
          ...
          _isNext ? resolve((0, _extends2.default)({}, res, {
  ...
  */
  ...
  http.nextPage = function nextPage(action, params, headers) {
    ...
    var _http$requestPageQueu = http.requestPageQueue[key],
        ...
        sendOpts = {};
    (0, _extends2.default)(sendOpts, params, {
      skip: skip,
      pagesize: pagesize
    });
    (0, _extends2.default)(http.requestPageQueue[key], {
      skip: skip + pagesize
    });
    return this[this instanceof _vue.default ? '$get' : 'get'](action, sendOpts, headers, true);
  };
  ...
  http.all = function all(requests) {
    ...
    return Promise.all(requests.map(function (request) {
      if (request instanceof Promise) {
        ...
        return _this[_this instanceof _vue.default ? '$get' : 'get'](action, params, headers);
      }
    }));
  };
    ...
    return Promise.race(requests.map(function (request) {
      if (request instanceof Promise) {
        ...
        var action = request.action,
            params = request.params,
            headers = request.headers;
        return _this2[_this2 instanceof _vue.default ? '$get' : 'get'](action, params, headers);
      }
    }));
  } // 中断当前未完成的request请求
  ;
