...
exports.urlQueriesSerialize = exports.urlParse = exports.urlJoin = exports.urlConcat = exports.getUrlSearches = exports.contains = void 0;
 ...
 * @return {any}
 */
var getUrlSearches = function getUrlSearches(options) {
  if (options === void 0) {
    options = {};
  }
  ...
  return (0, _extends2.default)({}, options, urlObject, proto);
};

exports.getUrlSearches = getUrlSearches;

var urlParse = function urlParse(urlString) {
  var searchObj = {};
...
var urlQueriesSerialize = function urlQueriesSerialize(queryObj, isEncode) {
  if (isEncode === void 0) {
    isEncode = false;
  }

  if (!(0, _lodash.isPlainObject)(queryObj)) {
...
exports.urlQueriesSerialize = urlQueriesSerialize;
...
var urlConcat = function urlConcat(txt) {
