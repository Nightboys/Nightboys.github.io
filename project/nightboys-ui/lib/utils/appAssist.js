...
exports.viewChange = exports.uploadImg = exports.titleBarHeight = exports.statusBarHeight = exports.showShareDialog = exports.shareActivity = exports.setTitleBar = exports.setTitle = exports.setRightMenu = exports.setLeftMenu = exports.sendCondition = exports.scrollChangeNavigate = exports.safeAreaInsetBottom = exports.requestNative = exports.redNews = exports.queryClob = exports.isIphonex = exports.isIOS = exports.isBounceEnable = exports.hideBackBtn = exports.gotoRelationLink = exports.goToF9Detail = exports.getAppVersion = exports.getAppFrom = exports.forbidAppPushUp = exports.fcWebview = exports.fcSetTitle = exports.fcSetStatusBarStyle = exports.fcSetRightMenus = exports.fcSetNavigationBarStyle = exports.fcSetBackButton = exports.fcRequest = exports.fcExportData = exports.fcAddBlock = exports.compressImg = exports.appSetSearchBarText = exports.appSelectSearchResult = exports.appSearchRelationship = exports.appSearchNews = exports.appSearchBeneficiary = exports.appSearchAnnouncement = exports.appScanQRCode = exports.appResearchReport = exports.appPreLoad = exports.appPage = exports.appOpenPage = exports.appOpenLeftWindow = exports.appModalAlert2 = exports.appModalAlert1 = exports.appGetVersionNumber = exports.appGetVersion = exports.appFeedback = exports.appDoLogin = exports.appCombinePages = exports.appCombinePage = exports.appCollapse = exports.appCheckVersion = exports.appCheckIn = exports.appAlert = exports.alertNative = void 0;
...
// 是否ios
var isIOS = !!window.navigator.userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/); // 是否全面屏ios(针对iphoneX之后机型)
...
var safeAreaInsetBottom = function safeAreaInsetBottom() {
  var result = 0;
...
exports.safeAreaInsetBottom = safeAreaInsetBottom;

var appPreLoad = function appPreLoad(url) {
...
exports.appPreLoad = appPreLoad;

var appOpenLeftWindow = function appOpenLeftWindow(url) {
  try {
...
exports.appOpenLeftWindow = appOpenLeftWindow;

var getAppFrom = function getAppFrom() {
...
exports.getAppFrom = getAppFrom;

var appCollapse = function appCollapse(isCollapse) {
  try {
...
exports.appCollapse = appCollapse;

var appAlert = function appAlert(_temp) {
  ...
  location = "fcnews://alert" + (0, _urls.urlQueriesSerialize)((0, _utils.removeObjectNil)({
    title: title,
    message: message,
    okname: okname,
...
var appCombinePage = function appCombinePage(_temp2) {
  ...
  location = "fcnews://websPage" + (0, _urls.urlQueriesSerialize)((0, _utils.removeObjectNil)({
    title: title,
    subTitle: subTitle,
...
exports.appCombinePage = appCombinePage;

var appCombinePages = function appCombinePages(index, datas) {
  if (datas === void 0) {
    datas = [];
  }
...
exports.appCombinePages = appCombinePages;

var appSelectSearchResult = function appSelectSearchResult(text, result) {
  location = "fcnews://searchSelectedHandler?" + (0, _urls.urlQueriesSerialize)((0, _utils.removeObjectNil)({
    text: text,
    result: result
  }));
};
...
exports.appSelectSearchResult = appSelectSearchResult;

var appResearchReport = function appResearchReport(seminarCodes) {
...
exports.appResearchReport = appResearchReport;

var appScanQRCode = function appScanQRCode() {
...
exports.appScanQRCode = appScanQRCode;

var appOpenPage = function appOpenPage(link) {
  if (link === void 0) {
    link = '';
  }
...
exports.appOpenPage = appOpenPage;

var appSetSearchBarText = function appSetSearchBarText(text) {
  if (text === void 0) {
    text = '';
  }
...
exports.appSetSearchBarText = appSetSearchBarText;

var appFeedback = function appFeedback(txt) {
  if (txt === void 0) {
    txt = '';
  }
...
var appCheckIn = function appCheckIn() {
  location = 'https://ari.finchina.com/finchinaAPP/checkIn';
}; // 搜新闻


exports.appCheckIn = appCheckIn;

var appSearchNews = function appSearchNews() {
  location = 'https://ari.finchina.com/finchinaAPP/newsSearch';
}; // 搜公告


exports.appSearchNews = appSearchNews;

var appSearchAnnouncement = function appSearchAnnouncement() {
  location = 'https://ari.finchina.com/finchinaAPP/noticeSearch';
}; // 查关系


exports.appSearchAnnouncement = appSearchAnnouncement;

var appSearchRelationship = function appSearchRelationship() {
  location = 'https://ari.finchina.com/finchinaAPP/relationshipSearch';
}; // 查受益所有人


exports.appSearchRelationship = appSearchRelationship;

var appSearchBeneficiary = function appSearchBeneficiary() {
  location = 'https://ari.finchina.com/finchinaAPP/profitSearch';
}; // 版本检测


exports.appSearchBeneficiary = appSearchBeneficiary;

var appCheckVersion = function appCheckVersion() {
...
exports.appCheckVersion = appCheckVersion;

var appGetVersion = function appGetVersion() {
...
exports.appGetVersion = appGetVersion;

var appGetVersionNumber = function appGetVersionNumber() {
  var versionNumber;
...
exports.appGetVersionNumber = appGetVersionNumber;

var sendCondition = function sendCondition(condition) {
...
exports.sendCondition = sendCondition;

var hideBackBtn = function hideBackBtn(hide) {
  /* eslint-disable */
  try {
...
exports.hideBackBtn = hideBackBtn;

var goToF9Detail = function goToF9Detail(_ref3) {
  var name = _ref3.name,
      id = _ref3.id,
      type = _ref3.type;
...
exports.goToF9Detail = goToF9Detail;

var redNews = function redNews(redNewList, code) {
...
exports.redNews = redNews;

var shareActivity = function shareActivity(opts) {
  opts = (0, _extends2.default)({
    url: location.href,
...
var appModalAlert1 = function appModalAlert1(_ref4) {
...
exports.appModalAlert1 = appModalAlert1;

var appModalAlert2 = function appModalAlert2(_ref5) {
...
exports.appModalAlert2 = appModalAlert2;

var setTitle = function setTitle(str) {
  // let title = str;
...
var titleBarHeight = function titleBarHeight() {
  var result = 44; // try {
...
var gotoRelationLink = function gotoRelationLink(_ref6) {
  var from = _ref6.from,
      to = _ref6.to,
...
exports.gotoRelationLink = gotoRelationLink;

var forbidAppPushUp = function forbidAppPushUp(isForbid) {
  try {
...
exports.forbidAppPushUp = forbidAppPushUp;

var setTitleBar = function setTitleBar(opts) {
  //opts = {
  //   "showTitleBar": true,
...
var setLeftMenu = function setLeftMenu(opts) {
  //opts = [{
  //
  //  "linkUrl": "",//优先判断该字段
...
var setRightMenu = function setRightMenu(str) {
...
exports.setRightMenu = setRightMenu;

function getTempName() {
  return 'finchinaAPP_' + Math.random().toString().split('.')[1];
}

var queryClob = function queryClob(data, self) {
...
exports.queryClob = queryClob;

var isBounceEnable = function isBounceEnable(isEnable) {
  /* eslint-disable */
  try {
...
exports.isBounceEnable = isBounceEnable;
...
var viewChange = function viewChange(isLandscape) {
  try {
    console.log('触发啦');
...
var scrollChangeNavigate = function scrollChangeNavigate(isScroll) {
  try {
...
exports.scrollChangeNavigate = scrollChangeNavigate;
window.isLogin = false; //当前是否已登录，默认false

var appDoLogin = function appDoLogin(_ref7) {
...
exports.appDoLogin = appDoLogin;

var uploadImg = function uploadImg(data, self) {
  var name = getTempName();
...
var compressImg = function compressImg(file, callback) {
...
var appPage = function appPage(opts) {
  if (opts === void 0) {
    opts = {
...
var requestNative = function requestNative(requestData) {
...
var alertNative = function alertNative(opts) {
  var configData = {
    style: 'v1',
  ...
  if (getAppVersion() >= 6.0) {
    var params = {
      data: (0, _extends2.default)({}, configData, opts, {
    ...
    var dataStr = JSON.stringify((0, _extends2.default)({}, configData, opts));
...
exports.alertNative = alertNative;

var showShareDialog = function showShareDialog(params) {
  // 版本判断
  if (getAppVersion() >= 6.0) {
...
var fcSetTitle = function fcSetTitle(params) {
  // 版本判断
  if (getAppVersion() >= 6.0) {
    params = (0, _extends2.default)({}, {
      data: {
...
exports.fcSetTitle = fcSetTitle;

var fcSetBackButton = function fcSetBackButton(params) {
  // 版本判断
  if (getAppVersion() >= 6.0) {
    params = (0, _extends2.default)({}, {
      data: {// icon: '',
...
exports.fcSetBackButton = fcSetBackButton;

var fcSetRightMenus = function fcSetRightMenus(params) {
  // 版本判断
  if (getAppVersion() >= 6.0) {
    try {
...
exports.fcSetRightMenus = fcSetRightMenus;

var fcSetNavigationBarStyle = function fcSetNavigationBarStyle(params) {
  // 版本判断
  if (getAppVersion() >= 6.0) {
    params = (0, _extends2.default)({}, {
...
exports.fcSetNavigationBarStyle = fcSetNavigationBarStyle;

var fcSetStatusBarStyle = function fcSetStatusBarStyle(params) {
  // 版本判断
  if (getAppVersion() >= 6.0) {
    params = (0, _extends2.default)({}, {
      data: {
...
exports.fcSetStatusBarStyle = fcSetStatusBarStyle;

var fcRequest = function fcRequest(params) {
  if (getAppVersion() >= 6.0) {
    params = (0, _extends2.default)({}, {
      data: {//以文件上传为例
...
var fcWebview = function fcWebview(params) {
  params = (0, _extends2.default)({}, {
    hideNavigation: 0,
    //1: 隐藏, 0: 不隐藏
    link: '' //url路径
...
exports.fcWebview = fcWebview;

var fcExportData = function fcExportData(params) {
  // 版本判断
  if (getAppVersion() >= 6.0) {
    try {
...
exports.fcExportData = fcExportData;

var fcAddBlock = function fcAddBlock(params) {
  params = (0, _extends2.default)({}, {
    fail: function fail(res) {
