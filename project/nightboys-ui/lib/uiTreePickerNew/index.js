...
require("vant/lib/skeleton/style");

var _skeleton = _interopRequireDefault(require("vant/lib/skeleton"));

require("vant/lib/field/style");

var _field = _interopRequireDefault(require("vant/lib/field"));

var _webpackZepto = _interopRequireDefault(require("webpack-zepto"));

var _vue = _interopRequireDefault(require("vue"));

var _index = require("../utils/http/index");
...
_vue.default.use(_index.http);

_vue.default.use(_skeleton.default).use(_field.default);

var queryParams = (0, _urls.getUrlSearches)();
...
var _default2 = {
  ...
  components: {
    uiNoDatas: _uiNotFound.default,
    treeView: _tree.default
  },
  ...
  watch: {
    ...
    treeData: {
      ...
      immediate: true,
      handler: function handler(val) {
        var value = _webpackZepto.default.extend(true, [], val),
            list = this.handlerTreeData(value);

        this.dataList = _webpackZepto.default.extend(true, [], list);
        this.initList = _webpackZepto.default.extend(true, [], this.initTreeData(val));
    ...
    defaultCheckdKeys: {
      handler: function handler(val) {
        ...
        var list = _webpackZepto.default.extend(true, [], this.initList);

        this.dataList = _webpackZepto.default.extend(true, [], this.handlerTreeData(list));
        this.selectKeysList = Array.from(new Set([].concat(this.defaultCheckdKeys)));
        this.$nextTick(function () {
  ...
  methods: {
    ...
    getSearchHandler: function getSearchHandler() {
      ...
      this.$get(this.searchUrl, (0, _utils.removeObjectNil)((0, _extends2.default)({}, queryParams, {
    ...
    highlight: function highlight(keywords, val) {
      ...
      keywords.forEach(function (d) {
        var replaceReg = new RegExp((0, _utils.replaceSepcialTxt)(d), 'g'),
            // 匹配关键字正则
