<template>
  <div
    @click.stop
    class="menu-single"
    :class="[{ 'menu-has-scroll': hasScroll }, this.type]"
  >
        ...
        <li v-for="(obj, idx) in list" :key="idx">
          <dl class="btn-group">
            <dd
              ...
              :class="[
                o.extraClass,
                { 'menu-selected': o.selected, 'menu-disabled': o.disabled },
              ]"
...
export default {
  ...
  methods: {
    ...
    selectedItem(o, obj) {
      ...
      let selectList = o.selected
        ? [Object.assign({}, o, { params: obj.key })]
        : [];

      this.$emit(
        'menuSubmit',
        { idx: this.idx, list: this.list, selectList },
        'singleDatePicker'
      );
      if (
