    ...
    <div class="menu-scroll" v-scroll-fix>
      <ul>
        <li v-for="(obj, objIdx) in list" :key="objIdx">
          ...
          <div class="special" :class="{ active: obj.datePickType }" v-if="obj.needDatePcker">
            <date-picker type="datePicker" :idx="objIdx" :extraObj="obj" @updateDate="updateDate"></date-picker>
          </div>
        </li>
      </ul>
    </div>
